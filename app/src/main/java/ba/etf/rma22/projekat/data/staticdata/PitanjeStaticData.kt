...
fun dajPitanjaStaticData() : List<Pitanje>{
    return listOf(
        ...
        Pitanje("pitanje7", "Koliko mrav ima nogu", listOf("0","1","2","3","5")),
        Pitanje("pitanje8", "Koliko pauk ima nogu", listOf("0","1","2","3","5")),
        Pitanje("pitanje9", "Koliko zec ima nogu", listOf("0","1","2","3","4","5")),
