...
fun dajAnketeStatic(): List<Anketa>{
    ...
    return listOf(
        ...
        Anketa("Anketa 4","lagano istrazivanje", date7 , date, null,10,
        ...
        Anketa("Anketa 10","zadovoljavajuce istrazivanje", date2 , date3, date2,10,
            "grupica 1", 0.6f), //treba biti ispunjena tj plava
        Anketa("Anketa 11","zadovoljavajuce istrazivanje", date2 , date3, date2,10,
        ...
        Anketa("Anketa 13","zadovoljavajuce istrazivanje2", date2 , date3, date2,10,
            "grupica 1", 0.6f), //treba biti ispunjena tj plava
        Anketa("Anketa 14","zadovoljavajuce istrazivanje2", date2 , date3, date2,10,
            "grupica 2", 0.6f), //treba biti ispunjena tj plava
        Anketa("Anketa 15","zadovoljavajuce istrazivanje2", date2 , date3, null,10,
            "grupica 3", 0.6f), //treba biti zuto

        Anketa("Anketa 16","srednje tesko istrazivanje", date2 , date3, date2,10,
            "grupica 1", 0.6f), //treba biti ispunjena tj plava
        ...
        Anketa("Anketa 19","srednje tesko istrazivanje2", date2 , date3, date2,10,
            "grupica 1", 0.6f), //treba biti ispunjena tj plava
        ...
        Anketa("Anketa 22","zanimljivo istrazivanje", date2 , date3, date2,10,
            "grupica 1", 0.6f), //treba biti ispunjena tj plava
        Anketa("Anketa 23","zanimljivo istrazivanje", date2 , date3, date2,10,
            "grupica 2", 0.6f), //treba biti ispunjena tj plava
        Anketa("Anketa 24","zanimljivo istrazivanje", date2 , date3, date2,10,
            "grupica 3", 0.6f), //treba biti ispunjena tj plava

        Anketa("Anketa 25","zanimljivo istrazivanje2", date2 , date3, date2,10,
            "grupica 1", 0.6f), //treba biti ispunjena tj plava
        Anketa("Anketa 26","zanimljivo istrazivanje2", date2 , date3, date2,10,
            "grupica 2", 0.6f), //treba biti ispunjena tj plava
        Anketa("Anketa 27","zanimljivo istrazivanje2", date2 , date3, date2,10,
            "grupica 3", 0.6f), //treba biti ispunjena tj plava
